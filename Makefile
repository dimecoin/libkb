...
CFLAGS =  -O2 -fno-strength-reduce -Wall -Wcast-align -Wwrite-strings
...
CONFIG_CLEAN_FILES = 
DIST_COMMON =  INSTALL Makefile.am Makefile.in NEWS acconfig.h \
acinclude.m4 aclocal.m4 config.hin configure configure.in stamp-h.in
...
$(ACLOCAL_M4): #M# configure.in  acinclude.m4 \
		acconfig/m4/byteorder.m4 acconfig/m4/ccansi.m4 \
		acconfig/m4/ccbugcast.m4 acconfig/m4/checkergcc.m4 \
		acconfig/m4/chkfunc.m4 acconfig/m4/gccbugsi.m4 \
		acconfig/m4/gccbugsr.m4 acconfig/m4/gnumake.m4 \
		acconfig/m4/limits.m4 acconfig/m4/memcmp.m4 \
		acconfig/m4/pipe.m4 acconfig/m4/promote.m4 \
		acconfig/m4/sizeof.m4
	cd $(srcdir) && $(ACLOCAL) $(ACLOCAL_AMFLAGS)

config.status: $(srcdir)/configure
	$(SHELL) ./config.status --recheck
$(srcdir)/configure: #M#$(srcdir)/configure.in $(ACLOCAL_M4) $(CONFIGURE_DEPENDENCIES)
	cd $(srcdir) && $(AUTOCONF)
...
$(srcdir)/config.hin: #M#$(srcdir)/stamp-h.in
